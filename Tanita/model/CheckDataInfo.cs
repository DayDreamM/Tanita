...
namespace Tanita.model
{
    class CheckDataInfo
    {
        ...
        public string Advice { get; set; }
            ...
            public string ReportImgName { get; set; }

            public string ReportImgNamePhy { get; set; }

            public string ReportImgUrl { get; set; }

            public string ReportPdfPhy { get; set; }
            ...
            public string UploadErrReason { get; set; }
            ...
            public decimal Xr { get; set; }

            public decimal XR { get; set; }

            public decimal YaoTunBi { get; set; }
